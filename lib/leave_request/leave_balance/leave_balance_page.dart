...
class _LeaveBalancePage extends State<LeaveBalancePage> implements LeaveBalanceView
   {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      child: Column(
        children: [
          Expanded(
            child: _response.leaveBalanceList!=null?ListView(
            children: [
            Header(headerText: 'Leave  Balance',),
    Padding(
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${_response?.leaveBalanceList[0]?.paidLeave??""}',style: TextStyle(
                                    fontSize: 20.0,fontWeight: FontWeight.bold
                                ),),
                              ],
                            ),
                  ...
                  children: [
                    Flexible(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Unpaid Leave',style: TextStyle(
                              fontSize: 20.0,fontWeight: FontWeight.bold
                          ),),
                          SizedBox(height: 20.0,),
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${_response?.leaveBalanceList[0]?.unpaidLeave ?? ""}',style: TextStyle(
                                    fontSize: 20.0,fontWeight: FontWeight.bold
                                ),),
                              ],
                            ),
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${_response?.leaveBalanceList[0]?.sickLeave?? ""}',style: TextStyle(
                                    fontSize: 20.0,fontWeight: FontWeight.bold
                                ),),
                              ],
                            ),
                  ...
                  children: [
                    Flexible(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Floater Leave',style: TextStyle(
                              fontSize: 20.0,fontWeight: FontWeight.bold
                          ),),
                          SizedBox(height: 20.0,),
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${_response.leaveBalanceList[0].floaterLeave}',style: TextStyle(
                                    fontSize: 20.0,fontWeight: FontWeight.bold
                                ),),
                              ],
                            ),
                        ...
                        children: [
                          Flexible(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Special Leave',style: TextStyle(
                                    fontSize: 20.0,fontWeight: FontWeight.bold
                                ),),
                                SizedBox(height: 20.0,),
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${_response?.leaveBalanceList[0]?.specialLeave?? ""}',style: TextStyle(
                                          fontSize: 20.0,fontWeight: FontWeight.bold
                                      ),),
                                    ],
                                  ),
                        ...
                        children: [
                          Flexible(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Maternity Leave',style: TextStyle(
                                    fontSize: 20.0,fontWeight: FontWeight.bold
                                ),),
                                SizedBox(height: 20.0,),
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${_response?.leaveBalanceList[0]?.maternityLeave?? ""}',style: TextStyle(
                                          fontSize: 20.0,fontWeight: FontWeight.bold
                                      ),),
                                    ],
                                  ),
                        ...
                        children: [
                          Flexible(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Paternity Leave',style: TextStyle(
                                    fontSize: 20.0,fontWeight: FontWeight.bold
                                ),),
                                SizedBox(height: 20.0,),
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${_response.leaveBalanceList[0].paternityLeave}',style: TextStyle(
                                          fontSize: 20.0,fontWeight: FontWeight.bold
                                      ),),
                                    ],
                                  ),
                        ...
                        children: [
                          Flexible(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Bereavement Leave',style: TextStyle(
                                    fontSize: 20.0,fontWeight: FontWeight.bold
                                ),),
                                SizedBox(height: 20.0,),
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${_response?.leaveBalanceList[0]?.bereavementLeave??""}',style: TextStyle(
                                          fontSize: 20.0,fontWeight: FontWeight.bold
                                      ),),
                                    ],
                                  ),
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${_response?.leaveBalanceList[0]?.casualLeave?? ""}',style: TextStyle(
                                          fontSize: 20.0,fontWeight: FontWeight.bold
                                      ),),
                                    ],
                                  ),
