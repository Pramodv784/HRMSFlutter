...
const textStyleGreen18pxW600 = TextStyle(
    color: AppColors.textColorGreen,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w600,
    fontSize: fontH3);

const textStyleWhite18pxW600 = TextStyle(
    color: AppColors.white,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w600,
    fontSize: 18);

const textStyleWhite18pxW500 = TextStyle(
    color: AppColors.white,
    fontFamily: kFontFamily,
...
const textStyleSubText18pxW500 = TextStyle(
...
const textStyleOrange12px600w = TextStyle(
...
const textStyleSubText22px600w = TextStyle(
    color: AppColors.textColorSubText,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w600,
    fontSize: 22);
...
const textStyleDark20px600w = TextStyle(
    color: AppColors.textColorBlack,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w600,
    fontSize: 20);
...
const textStyleWhiteUnSelect12px400w = TextStyle(
...
const textStyleRed14px600w = TextStyle(
    color: Colors.red,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w600,
    fontSize: 14);
...
const textStyleDark14px400w = TextStyle(
    color: AppColors.textColorBlack,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w400,
    fontSize: 14);
...
const textStyleSecondaryDark14px500w = TextStyle(
...
const textStyle14px300w = TextStyle(
    color: AppColors.colorSecondaryDark,
    fontFamily: kFontFamily,
...
const textStyleDark16px500w = TextStyle(
    color: AppColors.textColorBlack,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w500,
    fontSize: fontH4);
...
const textStyleWhite14px400w = TextStyle(
    color: AppColors.white,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w400,
    fontSize: 14);
...
const textStyleRegular64px600w = TextStyle(
    color: AppColors.textColorBlack,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w700,
    fontSize: 64);
...
textStyleBlue24px600wRes(BuildContext context) => TextStyle(
    color: AppColors.textColorBlue,
    fontFamily: kFontFamily,
    fontWeight: FontWeight.w600,
